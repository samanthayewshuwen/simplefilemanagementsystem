...
export default {
  ...
  methods: {
    ...
    openDialog(note) {
      if (note) this.editedNote = { ...note, imageFile: null };
      else this.editedNote = { title: "", content: "", image: null, imageFile: null };
      this.dialog = true;
    },
    ...
    async confirmAndSave() {
      if (!this.editedNote.title) { alert("Title required"); return; }
